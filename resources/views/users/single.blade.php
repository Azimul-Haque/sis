    ...
    <div class="card card-primary card-outline card-outline-tabs">
      <div class="card-header p-0 border-bottom-0">
        <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
          ...
          <li class="nav-item">
            <a class="nav-link" id="custom-tabs-four-profile-tab" href="{{ route('dashboard.users.singleother', $user->id) }}" role="tab" aria-controls="custom-tabs-four-profile" aria-selected="false">ব্যয়ের তালিকা</a>
          </li>
        </ul>
      </div>
      <div class="card-body">
