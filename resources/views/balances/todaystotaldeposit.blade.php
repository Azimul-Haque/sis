              ...
              @foreach($deposits as $deposit)
                <tr>
                  <td style="line-height: 1;">
                    ...
                    <small>
                        <span class="text-black-50">প্রদান করেছেনঃ </span> {{ $deposit->user->name }},
                        <span class="text-black-50">গ্রহণ করেছেনঃ </span> {{ $deposit->receiver ? $deposit->receiver->name : ''}}<br/>
                        <span class="text-black-50">মাধ্যমঃ </span> {{ $deposit->medium ? $deposit->medium : ''}}, <span class="text-black-50">বিবরণঃ </span> {{ $deposit->description ? $deposit->description : ''}}<br/>
